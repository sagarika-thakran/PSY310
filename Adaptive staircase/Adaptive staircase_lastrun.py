...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Sugandha\\OneDrive\\Desktop\\PSY 350\\Adaptive staircase\\Adaptive staircase_lastrun.py',
