...
expName = 'Intentional Binding Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Sugandha\\Downloads\\Intentional Binding Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and the beep sound (on a scale of 0-999). \nClick submit after entering the value.',
        font='Arial',
