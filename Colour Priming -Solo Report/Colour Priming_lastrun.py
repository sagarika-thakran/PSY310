...
expName = 'Colour Priming'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Sugandha\\OneDrive\\Desktop\\Colour Priming\\Colour Priming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    introduction_text = visual.TextStim(win=win, name='introduction_text',
        text='"Greetings! \nIn the upcoming task, you will see different objects in varying colors. Your goal is to identify the accurate depiction of the object as quickly and accurately as possible. \n\nPress \'y\' if you can identify the image, and press \'n\' if you cannot. \n\nIf, at any point in the experiment you feel the need or want to exit the experiment, please press the Escape button. Press space bar when you\'re ready to proceed."',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('Conditions for the control group.xlsx'),
